                ...
                <div className='flex flex-row gap-6'>
                    <div className='w-3/4 bg-[#F6F6F6] border border-black/10 shadow-sm px-8 py-6 rounded-xl'>
                        <div className='flex flex-row items-center mb-4 gap-3'>
                            ...
                            <h3 className='text-xl font-semibold text-black/80'>Shopping Cart</h3>
                        </div>
                    ...
                    <div className='flex-1 h-fit bg-[#F6F6F6] border border-black/10 shadow-sm px-8 py-6 rounded-xl'>
